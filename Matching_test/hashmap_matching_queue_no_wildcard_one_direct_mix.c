...
static inline int matching_hash_func(int tag, int peer)
{
    int maskA = 0b0101;
    int maskB = 0b1010;
    return (tag &maskA) & (peer & maskB);
}

#define IMPLEMENTATION_NAME_STRING "hashmap_no_wild_one_bin_mix"
#define IMPLEMENTATION_NAME_FUNCTION_PREFIX hashmap_no_wild_one_bin_mix
